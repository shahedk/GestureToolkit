/*
 * Source: http://www.codeproject.com/KB/recipes/combinatorial_in_csharp.aspx
 */
...
namespace Combinatorial
{
    ...
    abstract public class CombinatorialBase : IEnumerator
    {
        ...
        protected TouchPoint2[] m_arrayObj;
        ...
        protected TouchPoint2[] m_arrayCurrentObj;
        ...
        protected CombinatorialBase(IEnumerator enumeratorObjects, int nKlass)
        {
            ...
            m_arrayObj = new TouchPoint2[nEnumCount]; //Array.CreateInstance(Type.GetType("System.Object"), nEnumCount);
            int i = 0;
            enumeratorObjects.Reset();
            while (enumeratorObjects.MoveNext())
            {
                m_arrayObj[i] = enumeratorObjects.Current as TouchPoint2;
                i++;
            }
        }
        ...
        protected TouchPoint2[] NextItems()
        {
            ...
            for (int j = 0; j < m_arrayIndeces.Length; j++)
            {
                ...
                m_arrayCurrentObj[j] = m_arrayObj[nIndex];
            }
        ...
        protected TouchPoint2[] CurrentItems()
        {
